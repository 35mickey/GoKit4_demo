...
static void uart_rx_cb(uint32_t num_bytes, void *cb_data)
{
	...
	gizLog(LOG_INFO,"[uart_rx_cb] uart_rx_cb data [%d][%s] \n", num_bytes, uart_conf->rx_buff);
