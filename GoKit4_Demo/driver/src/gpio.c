...
//	gpio_config(PIN_E_GPIO_05, QAPI_GPIO_INPUT_E, QAPI_GPIO_PULL_UP_E, QAPI_GPIO_2MA_E);
	...
	/* For oled */
	gpio_config(PIN_E_GPIO_01, QAPI_GPIO_OUTPUT_E, QAPI_GPIO_PULL_UP_E, QAPI_GPIO_10MA_E);
	gpio_config(PIN_E_GPIO_02, QAPI_GPIO_OUTPUT_E, QAPI_GPIO_PULL_UP_E, QAPI_GPIO_10MA_E);
	gpio_config(PIN_E_GPIO_03, QAPI_GPIO_OUTPUT_E, QAPI_GPIO_PULL_UP_E, QAPI_GPIO_10MA_E);
	gpio_config(PIN_E_GPIO_04, QAPI_GPIO_OUTPUT_E, QAPI_GPIO_PULL_UP_E, QAPI_GPIO_10MA_E);
}


void GPIO05_falling(qapi_GPIOINT_Callback_Data_t data)
{
	//Never print log in this callback
	key1_state = KEY_ON;
}
