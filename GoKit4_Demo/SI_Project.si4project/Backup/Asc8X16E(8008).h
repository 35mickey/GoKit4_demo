...
// ------------------  ASCII字模的数据表 ------------------------ //
// 码表从0x20~0x7e                                                //
// 字库: H:\TFT1.44寸彩屏资料【ST7735S内核】V5.0\汉字字库取模\lcd汉字取模软件\Asc8X16E.dat 纵向取模下高位//
// -------------------------------------------------------------- //
const unsigned char Zk_ASCII8X16[] =          // ASCII
{
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,  //无法显示的符号
