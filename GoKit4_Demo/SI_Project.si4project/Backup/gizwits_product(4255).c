    ...
    for(i = 0; i < info->num; i++)
    {
		...
		case EVENT_Motor :
         ...
         case EVENT_Sensor2:
            ...
            {
            	currentDataPoint.valueSensor1 = currentDataPoint.valueSensor2 + 1;
            }
            break;
...
void ICACHE_FLASH_ATTR userHandle(void)
{
    ...
    */
	currentDataPoint.valueSensor1 = 635;
...
void ICACHE_FLASH_ATTR userInit(void)
{
	...
	currentDataPoint.valueSensor1 = 666;

	currentDataPoint.valueStr1[0]=0x63;
	currentDataPoint.valueStr1[1]=0x91;
	currentDataPoint.valueStr1[2]=0xA5;
	currentDataPoint.valueStr1[3]=0xEE;
	currentDataPoint.valueStr1[4]=0x38;
