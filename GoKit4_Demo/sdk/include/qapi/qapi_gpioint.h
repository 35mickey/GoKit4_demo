...
$Header: //components/rel/core.tx/1.0/api/systemdrivers/qapi_gpioint.h#8 $
...
#define  TXM_QAPI_GPIOINT_REGISTER_INTERRUPT_CB      CUSTOM_CB_QAPI_GPIO_BASE
...
#define qapi_GPIOINT_Register_Interrupt(a,b,c,d,e,f,g)  ((UINT) (_txm_module_system_call12)(TXM_QAPI_GPIOINT_REGISTER_INTERRUPT , (ULONG) a, (ULONG) b, (ULONG) c, (ULONG) d, (ULONG) e, (ULONG) f, (ULONG) g, (ULONG) qapi_custom_cb_gpioint_dispatcher, (ULONG) 0, (ULONG) 0, (ULONG) 0, (ULONG) 0))
