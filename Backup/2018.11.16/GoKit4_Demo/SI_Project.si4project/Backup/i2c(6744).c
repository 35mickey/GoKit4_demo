...
//	qt_uart_dbg(uart_conf.hdlr,"i2c_read: slave_addr[0x%x], reg[0x%x]\r\n", device_Address, reg);
	...
	res = qapi_I2CM_Transfer (i2c_handle, &config, &desc[0], 2, client_callback, &CB_Parameter, 100);
...
//	qt_uart_dbg(uart_conf.hdlr,"i2c_read: slave_addr[0x%x], reg[0x%x]\r\n", device_Address, reg);
	...
	res = qapi_I2CM_Transfer (i2c_handle, &config, &desc[0], 1, client_callback, &CB_Parameter, 100);
