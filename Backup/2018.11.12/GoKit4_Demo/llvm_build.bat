...
rem ###################### driver by Mickey start #####################
set DRIVER_DIR=%PROJECT_PATH%\driver
set DRIVER_INCPATHS=-I %DRIVER_DIR%\inc -I %MAIN_DIR%

rem ###################### driver by Mickey end #####################
...
for %%x in (%MAIN_DIR%\*.c) do (
 %COMPILER%  -c  %DAM_CPPFLAGS% %GAGENT_CPPFLAGS% %DAM_CFLAGS% %APP_CFLAGS% %DAM_INCPATHS% %DRIVER_INCPATHS% %GAGENT_INC% %%x
