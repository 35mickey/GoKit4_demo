...
#define QT_UART_PORT_01		QAPI_UART_PORT_005_E
...
#define UART_RX1_BUFF_SIZE	(4*1024)
#define UART_TX1_BUFF_SIZE	(4*1024)
#define UART_RX2_BUFF_SIZE	(4*1024)
#define UART_TX2_BUFF_SIZE	(4*1024)
#define UART_RX3_BUFF_SIZE	(4*1024)
#define UART_TX3_BUFF_SIZE	(4*1024)
