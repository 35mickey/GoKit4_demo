...
* @{
*/
#define PRODUCT_KEY "5e913c1cb5dc461ea81971fbe5d7a21f"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "3a531055a6a54605be4fd81632cffffd"
...
* @{
*/
#define Motor_BYTEOFFSET                    0
#define Motor_BITOFFSET                     0
#define Motor_LEN                           1
#define Key_BYTEOFFSET                    	3
#define Key_BITOFFSET                     	0
#define Key_LEN                           	1

#define Sensor2_RATIO                       1
#define Sensor2_ADDITION                   	-1000
#define Sensor2_MIN                         0
#define Sensor2_MAX                         2000
#define Sensor1_RATIO                       1
#define Sensor1_ADDITION                    0
#define Sensor1_MIN                         0
#define Sensor1_MAX                         1000
/**@} */
...
typedef struct {
  bool valueMotor;
  int32_t valueSensor2;
  bool valueKey;
  uint32_t valueSensor1;
  uint8_t valueStr1[5];
} dataPoint_t;
